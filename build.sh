...
targets=("$@")
if [ 0 = "${#targets[@]}" ] ; then
    targets=(galaxys2 i777 epic4gtouch galaxynote)
fi
...
MODULES_epic4gtouch=("drivers/scsi/scsi_wait_scan.ko" "drivers/net/wireless/bcmdhd/dhd.ko" "fs/cifs/cifs.ko"  "crypto/md4.ko" "net/dns_resolver/dns_resolver.ko")
